...
public class TestManager {
    ...
    Ticket ticket1 = new Ticket(1, 2000, "AAAA", "BBBB", 120);
    ...
    Ticket ticket5 = new Ticket(5, 3000, "AAAA", "BBBB", 120);
    Ticket ticket6 = new Ticket(6, 700, "AAAA", "BBBB", 60);
    Ticket ticket7 = new Ticket(7, 1500, "DDDD", "CCCC", 300);
    Ticket ticket8 = new Ticket(8, 1800, "DDDD", "TTTT", 120);
    Ticket ticket9 = new Ticket(9, 700, "AAAA", "BBBB", 120);
    ...
    public void testSortTicket() {
        ...
        man.add(ticket8);
        man.add(ticket9);
        Ticket[] expected = {ticket6, ticket9, ticket2, ticket1, ticket5};
